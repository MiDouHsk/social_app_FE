...
const PostCardUserProfile = ({ userId }) => {
    ...
    const handleSharePosts = (postId) => {
        if (window.confirm("Bạn có thật sự muốn chia sẻ bài viết này không?")) {
                ...
                <div key={index} className="mb-4">
                    <div className="flex flex-col py-4 bg-white rounded-xl">
                        ...
                        <div className="flex justify-around items-center pt-4">
                            ...
                            <div className="flex items-center cursor-pointer rounded-lg p-2 hover:bg-gray-100" onClick={() => handleSharePosts(post.id)}>

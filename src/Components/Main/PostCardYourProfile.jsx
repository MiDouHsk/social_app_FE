                ...
                <div key={index} className="mb-4">
                    <div className="flex flex-col py-4 bg-white rounded-xl">
                        <div className="flex justify-start items-center pb-4 pl-4">
                            ...
                            <div className="w-full flex justify-end cursor-pointer mr-10" onClick={() => handleDeletePost(post.id)}>
                        ...
                        <div className="flex justify-around items-center pt-4">
                            ...
                            <div className="flex items-center cursor-pointer rounded-lg p-2 hover:bg-gray-100">
                                ...
                                <p className="font-roboto  text-md text-gray-700 no-underline tracking-normal leading-none" onClick={() => handleDeleteSharedPost(post.id)}>

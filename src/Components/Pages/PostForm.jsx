    ...
    const handleFormSubmit = async (e) => {
      ...
      try {
          ...
          if (image) {
              ...
              const mediaResponse = await axios.post('http://localhost:8080/posts/upload', formData, {
                     headers: {
          ...
          const postResponse = await axios.post('http://localhost:8080/posts/create', postData, {
              headers: {
                  'Authorization': `Bearer ${token}`
              }
          });
